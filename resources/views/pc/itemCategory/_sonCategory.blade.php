        ...
        <div class="row">
            <div class="col-xs-12 box">
                <ul class="list-inline">
                    ...
                    <li class="text-center {{ $showActive->isActiveCategory($category->id, $goodsCategoryInfo->id) }}"><a href="{{ route('pc.goodsCategorys.categorySon', ['id'=>$category->id]) }}" target="_self" title="{{ $category->name }}优惠券">{{ $category->name }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
