        ...
        <div class="row">
            <div class="col-xs-12">
                <ul class="list-inline pull-left">
                    ...
                    <li class="{{ $navTab->pcNavTabActive(route('pc.index')) }}"><a href="{{ route('pc.index') }}" title="优惠券">首页</a></li>
                    <li class="{{ $navTab->pcNavTabActive(route('pc.allGoodsCategory.index')) }}"><a href="{{ route('pc.allGoodsCategory.index') }}" title="优惠券商品分类" target="_blank">商品分类</a></li>
                    <li class="{{ $navTab->pcNavTabActive(route('pc.search.index')) }}"><a href="{{ route('pc.search.index') }}" title="优惠券查询" target="_blank">超级搜索</a></li>
                    ...
                    <li class="{{ $navTab->pcNavTabActive(route('pc.optimusMaterial.zhibo')) }}"><a href="{{ route('pc.optimusMaterial.zhibo', ['id'=>0]) }}" title="优惠券直播专场" target="_blank">好券直播</a></li>
                    <li class="{{ $navTab->pcNavTabActive(route('pc.optimusMaterial.baby')) }}"><a href="{{ route('pc.optimusMaterial.baby', ['id'=>0]) }}" title="母婴类tb优惠券专场" target="_blank">母婴生活馆</a></li>
                    <li class="{{ $navTab->pcNavTabActive(route('pc.optimusMaterial.brand')) }}"><a href="{{ route('pc.optimusMaterial.brand', ['id'=>0]) }}" title="大牌优惠券专场" target="_blank">大牌专场</a></li>
                    <li class="{{ $navTab->pcNavTabActive(route('pc.optimusMaterial.fashion')) }}"><a href="{{ route('pc.optimusMaterial.fashion') }}" title="优惠券潮流范专场" target="_blank">潮流街区</a></li>
                    <li class="{{ $navTab->pcNavTabActive(route('pc.optimusMaterial.recommend')) }}"><a href="{{ route('pc.optimusMaterial.recommend') }}" title="优惠券推荐专场" target="_blank">推荐好货</a></li>
                    <li class="{{ $navTab->pcNavTabActive(route('pc.optimusMaterial.sales')) }}"><a href="{{ route('pc.optimusMaterial.sales') }}" title="特价优惠券专场" target="_blank">特惠专场</a></li>
                </ul>
