<!--九宫格导航 开始-->
<div class="mui-row lbd-index-cate">
  <ul>
    <li>
      <a class="a-can-do" href="{{ route('wx.optimusMaterial.pintuan') }}" title="聚划算拼团">
        <div class="lbd-img"><img src="/wxstyle/images/categorys/pintuan.png"></div>
        <div class="lbd-text">拼团</div>
      </a>
    </li>
    <li>
    ...
    <li>
      <a class="a-can-do" href="{{ route('wx.taoqianggou.index') }}" title="淘抢购">
        <div class="lbd-img"><img src="/wxstyle/images/categorys/qiang.png"></div>
