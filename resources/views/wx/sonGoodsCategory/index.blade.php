  ...
  <div class="mui-row lbd-index-list-head lbd-fixed" id="lbd-index-list-head">
    <ul>
      <li class="{{ $showActive->showActiveForSort($sort, '') }}">
          <a title="{{ $goodsCategoryInfo->name }}优惠券" class="lbd-a-no-tap" href="{{ route('goodsCategorys.categorySon', $id) }}">精选</a>
      </li>
      <li class="{{ $showActive->showActiveForSort($sort, 'sales') }}">
          <a title="{{ $goodsCategoryInfo->name }}优惠券销量排序" class="lbd-a-no-tap" href="{{ route('goodsCategorys.categorySon', ['id' => $id, 'sort' => 'sales']) }}">销量</a>
      </li>
      <li class="{{ $showActive->showActiveForSort($sort, 'commi') }}">
          <a title="{{ $goodsCategoryInfo->name }}优惠券最热排序" class="lbd-a-no-tap" href="{{ route('goodsCategorys.categorySon', ['id' => $id, 'sort' => 'commi']) }}">最热</a>
      </li>
      <li class="{{ $showActive->showActiveForSort($sort, 'price') }}">
          <a title="{{ $goodsCategoryInfo->name }}优惠券价格排序" class="lbd-a-no-tap" href="{{ route('goodsCategorys.categorySon', ['id' => $id, 'sort' => 'price']) }}">价格</a>
      </li>
    </ul>
  </div>
