...
<nav class="mui-bar mui-bar-tab lbd-footer-tab lbd-goods-footer" id="lbd-footer-tab-item">
    <a title="优惠券" class="mui-tab-item" href="{{ route('wx.index') }}" style="width: 100%;">
    ...
    <a title="搜索关于{{ $itemInfo->title }}的tb优惠券" class="mui-tab-item" href="{{ route('wx.search.all') }}?q={{ $itemInfo->title }}" style="width: 100%;">
